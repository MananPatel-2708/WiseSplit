...
export default function LandingPage() {
  return (
    <div className="flex flex-col pt-16">
      {/* ───── Hero ───── */}
      <section className="mt-15 pb-12 space-y-10 md:space-y-15 px-5">
      ...
      {/* ───── How it works ───── */}
      <section id="how-it-works" className="py-15">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <Badge variant="outline" className="bg-green-100 text-green-700">
            How It Works
          </Badge>
      ...
      {/* ───── Call‑to‑Action ───── */}
      <section className="py-15 gradient">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
      ...
      {/* ───── Footer ───── */}
      <footer className="border-t bg-gray-50 py-10 text-center text-sm text-muted-foreground">
        © {new Date().getFullYear()} WiseSplit. All rights reserved.
      </footer>
    </div>
  );
}